...
def integrate(adata, 
    ...
    default_plots=[ "Chr",'TSSEnrichment', 'ReadsInTSS', 'ReadsInPromoter', 
       ...
       'total_counts_Exonic', 'log1p_total_counts_Exonic', 'pct_counts_Exonic', 
         'region', 'frag', 'overall_clust',"RNA.major.celltype.2_June20","RNA.minor.celltype.2_June20",
       "RNA.neuronal.layer.2_June20","RNA.neuronal.exttype.2_June20",
       "RNA.full.exttype.2_June20","RNA.inh.subtype.2_June20",
       "snATAC_TSS6_Major_celltype","snATAC_TSS6_Class","snATAC_TSS6_Subclass","leiden_clust","leiden_res1","leiden_res2",
       "Class_Aug4","Subclass_Aug5",'Class_July18', 'Library_type', 'Class_Aug4', 'Subclass_Aug5', 'Class', 'Subtype', 'Subclass_Aug16', 
       'Subclass_Aug17','Region', 'Subtype_Aug27', 'SubClass_Aug27','Pathology', 'Xushen.Celltype', 'Xushen.pred_cell_type_high_resolution', 'Xushen.pred_cell_type_lower_resolution','Source', 'Class_multiome', 'Subclass_multiome', 'Subtype_multiome','Class_ADmultiome', 'Subclass_ADmultiome', 'Subtype_ADmultiome']
