...
for (celltype in celltypes){
  ...
  # generate a new folder
    dir.create(paste0(celltype1,"_vs_",celltype, ".Mismatched.smooth.spline"), showWarnings = FALSE)
    setwd(paste0(celltype1,"_vs_",celltype, ".Mismatched.smooth.spline"))
  ...
  CircadianGenes <- CircadianGenes[CircadianGenes$phase_category=="Mismatched", ]
