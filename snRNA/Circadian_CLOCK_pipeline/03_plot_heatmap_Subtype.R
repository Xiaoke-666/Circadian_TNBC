...
files=list.files(pattern = "rna4.Cellbender.*.CircadianGenes.ZT4_10_16_22.top.sorted.tsv.gz")
celltypes <- unique(gsub("rna4.Cellbender.(.*).CircadianGenes.ZT4_10_16_22.top.sorted.tsv.gz", "\\1", files))
...
setwd("/net/bmc-lab4/data/kellis/users/zunpeng/05_results/02_circadian/03_snMultiome_Tumor_Jan19_2024/01_snRNA_cellbender/01_map_snATAC_UMAP/SingleCellVisualizationCircadianGenes_Subtype")
...
for (celltype in celltypes){
  ...
  CircadianGenes <- read.table(
    paste0("/net/bmc-lab4/data/kellis/users/zunpeng/05_results/02_circadian/03_snMultiome_Tumor_Jan19_2024/01_snRNA_cellbender/01_map_snATAC_UMAP/CircadianGenes_v2_Subtype/Integration/",
